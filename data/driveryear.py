...
def get_monza_years_by_driver() -> Dict[str, Dict[str, List[int]]]:
    """
    获取车手在蒙扎的参赛年份记录，包括参赛年份、完赛年份和未完赛年份

    Returns:
        Dict[str, Dict[str, List[int]]]: 车手名字和对应的参赛、完赛、未完赛年份列表
    """
    # 使用相对路径
    ...
    driver_career_limits = {
        ...
        "Alonso": (2001, 2024),  # Fernando Alonso: 2001-至今
        "Raikkonen": (2001, 2021),  # Kimi Räikkönen: 2001-2021
        "Hamilton": (2007, 2024),  # Lewis Hamilton: 2007-至今
        "Vettel": (2007, 2022),  # Sebastian Vettel: 2007-2022
        "Verstappen": (2015, 2024)  # Max Verstappen: 2015-至今
    }
...
def save_to_json(data: Dict[str, Dict[str, List[int]]], output_file: str = "driver_years.json"):
    ...
    Args:
        data (Dict[str, Dict[str, List[int]]]): 要保存的数据
